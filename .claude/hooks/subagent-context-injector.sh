...
context_injection="## Auto-Loaded Control-M Dashboard Project Context

This sub-agent has automatic access to the following project documentation:
- @$PROJECT_ROOT/CLAUDE.md (Control-M Dashboard overview, coding standards, and AI instructions)
- @$PROJECT_ROOT/docs/ai-context/project-structure.md (Complete Next.js file tree and tech stack)
- @$PROJECT_ROOT/docs/ai-context/docs-overview.md (Documentation architecture)
- @$PROJECT_ROOT/docs/specs/control-m-api-integration-spec.md (Control-M API integration details)

This is a Control-M monitoring dashboard built with Next.js, TypeScript, and React Query.
Key constraints: Read-only API access, secure proxy pattern, 30-second polling intervals.
