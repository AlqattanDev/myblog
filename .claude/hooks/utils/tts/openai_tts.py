...
async def main():
    ...
    try:
        ...
        try:
            ...
            # Save to temporary file and play with system player
            output_file = Path("temp_audio.mp3")
            ...
            try:
                ...
                try:
                    ...
                    print(f"⚠️  Please install afplay or mpv to play audio automatically")
                    print(f"🎵 Audio file saved at: {output_file.absolute()}")
